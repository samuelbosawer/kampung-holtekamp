...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(SuratController::class)->group(function(){
        ...
        Route::get('surat/{id}/ubah', [SuratController::class, 'edit'])->name('surat.ubah')->middleware(['auth','role.custom:rt|rw|kepala|warga|admin']);
        Route::put('surat/{id}', [SuratController::class, 'update'])->name('surat.update')->middleware(['auth','role.custom:rt|rw|kepala|warga|admin']);
    });
});

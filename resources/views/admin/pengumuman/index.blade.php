    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <div class="card">
                    <h5 class="card-header text-capitalize"> <i class="menu-icon tf-icons bx bx-news"></i> Data Pengumuman
                    </h5>
                        ...
                        <table class="table table-bordered">
                            <thead class="">
                                <tr class="bg-primary ">
                                    ...
                                    <th class="text-white text-center  p-3 fw-bolder">Cover</th>
                                    <th class="text-white text-center  p-3 fw-bolder">Penulis</th>

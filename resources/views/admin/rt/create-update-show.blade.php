                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            @error('nama_rt') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" name="kepala_rt"
                                ...
                                @if(Request::segment(3)=='detail') disabled @endif>
                            @error('kepala_rt') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>

                        <div class="col-md-8 mb-3">
                            <label class="form-label">RW</label>
                            <select name="rw_id" class="form-control" @if(Request::segment(3)=='detail') disabled @endif>
                            ...
                            @error('rw_id') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>

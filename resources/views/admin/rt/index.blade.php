    ...
    <div class="col-12">
        ...
        <div class="card">
            <h5 class="card-header text-capitalize">
                <i class="menu-icon tf-icons bx bx-box"></i> Data RT
            </h5>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr class="bg-primary">
                            ...
                            <th class="text-white text-center p-3 fw-bolder">RT</th>
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @forelse($datas as $data)
                            <tr>
                                ...
                                <td class="fw-bolder">
                                    <a href="{{ route('dashboard.rt.detail', $data->id) }}">
                                        {{ $data->nama_rt }}
                                    </a>
                                </td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('dashboard.rt.detail', $data->id) }}">
                                            ...
                                            <form action="{{ route('dashboard.rt.hapus', $data->id) }}"
                                                method="POST"

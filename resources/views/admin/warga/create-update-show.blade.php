                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror"
                            ...
                            <option value="L"
                                {{ old('jenis_kelamin', $data->jenis_kelamin ?? '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                            <option value="P"
                                {{ old('jenis_kelamin', $data->jenis_kelamin ?? '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                        @error('jenis_kelamin')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror"
                            ...
                            <option value="Belum Kawin"
                                {{ old('status', $data->status ?? '') == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin</option>
                            <option value="Sudah Kawin"
                                {{ old('status', $data->status ?? '') == 'Sudah Kawin' ? 'selected' : '' }}>Sudah Kawin</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="rw_id" name="rw_id" class="form-control @error('rw_id') is-invalid @enderror"
                            @if (Request::segment(3) == 'detail') disabled @endif>
                ...
                @if (!Auth::user()->hasRole('kepala|rw|warga'))
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                            name="password_confirmation" @if (Request::segment(3) == 'detail') disabled @endif>

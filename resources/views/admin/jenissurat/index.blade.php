    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <div class="card">
                    <h5 class="card-header text-capitalize"> <i class="menu-icon tf-icons bx bxs-envelope"></i> Data Jenis Surat
                        </h5>
                        ...
                        <table class="table table-bordered">
                            <thead class="">
                                <tr class="bg-primary ">
                                    ...
                                    <th class="text-white text-center  p-3 fw-bolder" >Jenis Surat</th>
                                    <th class="text-white text-center  p-3 fw-bolder" >Keterangan</th>
                                ...
                                @forelse($datas as $data)
                                    <tr>
                                        ...
                                        <td class="fw-bolder"> <a
                                                href="{{ route('dashboard.jenis-surat.detail', $data->id) }}">{{ $data->nama }}</a>
                                        </td>
                            ...
                            @if (!Auth::user()->hasRole('kepala|rw|warga'))
                                                    ...
                                                    <form action="{{ route('dashboard.jenis-surat.hapus', $data->id) }}"
                                                        method="POST"

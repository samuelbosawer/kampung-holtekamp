...
/* ==========================================================
   MODERN MINIMALIST GLASS THEME (SAFE VERSION)
...
/* ==========================================================
   8. SAFE REMOVE ANIMATIONS (TIDAK RUSAK SWEETALERT / MODAL)
   ========================================================== */

/* Matikan animasi GLOBAL, KECUALI komponen penting */
*:not(.swal2-container):not(.swal2-popup):not(.swal2-modal)
 :not(.modal):not(.fade):not(.show):not(.dropdown-menu) {
...
//* ==========================================================
   SWEETALERT HARD FIX (ANTI DISABLED & STUCK)
   ========================================================== */

/* Paksa semua tombol SweetAlert aktif */
.swal2-confirm,
.swal2-cancel,
.swal2-deny {
...
/* HAPUS efek disabled dari CSS global */
...
/* Pastikan SweetAlert benar-benar bisa menghilang */
